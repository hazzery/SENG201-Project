 ...
 * these teams will have stats that are privately scaled,
 ...
 * that there is a default range of stats e.g. 25-42 to begin
...
public class MatchSetUp {
    ...
    ArrayList<OppositionTeam> oppositionTeams = new ArrayList<>(NUM_MATCHES);
//    OppositionTeam match1 = new OppositionTeam("Metro FC"); // These don't currently align with the constructor
//    OppositionTeam match2 = new OppositionTeam("Garden FC"); // some thought needs to go into how we want to
//    OppositionTeam match3 = new OppositionTeam("Country FC");  // implement the opposition teams
    ...
    /**
	 * Determines the Difficulty Scalar based off of {@link this.difficulty} and {@link this.numMatches}.
	 *
	 * @return The Difficulty Scalar.
	 */
    public double difficultyScalar(){
        double scaleValue = difficulty * 0.5;
        return scaleValue + 0.05 * numMatches;
    }
    ...
    //Creates 3 Opposition Teams to choose from
